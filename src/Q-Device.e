...
ENUM ID_INQUIRE=1, ID_EJECT, ID_INSERT, ID_LOCK, ID_UNLOCK, ID_CAPACITY, ID_TESTREADY, ID_READTOC,
     ...
     ID_SHOWLOGS, ID_SHOWDEFECTS, ID_SAVELOG, ID_REWIND
...
DEF signal, result, running=TRUE,   probefrom[6]:STRING, probeto[6]:STRING, probefromtemp[6]:STRING,
    ...
    mui_showlogs_but, mui_autosense_cm, mui_showdefects_but, mui_savelog_but, mui_rewind_but, menu, diagflag=0,
    ...
    IF (reqtoolsbase:=OpenLibrary('reqtools.library', 38))=NIL THEN Raise(ERR_NOREQTOOLS)
    ...
    app:=ApplicationObject,
        ...
        MUIA_Application_Version    , '$VER: Q-Device! v0.6',
        ...
        MUIA_Window_Title       , 'Q-Device! V0.6 by Ian Chapman',
        MUIA_Window_ID          , "QDEV",
