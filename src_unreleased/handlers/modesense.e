...
PROC process_modesense_1D(page) ->DONE
    ...
    ELSEIF global_devtype=DEV_OPTICAL
        outlist('\ebInformation Page:\en', 'C/DVD Time Out & Protect')
        outlist('\ebPage Code:\en', '$1D')
        outlist_i('\ebPage Length:\en', Char(page+1), ' bytes')
        IF ((Char(page+3) AND %00000100)) = 0 THEN outlist('\ebTime-out Enabled:\en', 'No') ELSE outlist('\ebTime-out Enabled:\en', 'Yes')
        IF ((Char(page+3) AND %00000010)) = 0 THEN outlist('\ebPrevent of Medium Access:\en', 'No') ELSE outlist('\ebPrevent of Medium Access:\en', 'Yes')
        IF ((Char(page+3) AND %00000001)) = 0 THEN outlist('\ebSoftware Write Protect until Powerdown:\en', 'No') ELSE outlist('\ebSoftware Write Protect until Powerdown:\en', 'Yes')
        outlist_i('\ebGroup 1 Minimum Timeout:\en', Int(page+6), ' secs')
        outlist_i('\ebGroup 2 Minimum Timeout:\en', Int(page+8), ' secs')
    ELSE
        outlist('\ebInformation Page:\en', 'Unsupported or Reserved for this device class')
        outlist('\ebPage Code:\en', '$1D')
    ENDIF
...
PROC process_modesense_2A(page)
    ...
    ELSEIF global_devtype=DEV_OPTICAL
        outlist('\ebInformation Page:\en', 'C/DVD Capabilities and Mechanical Status')
        outlist('\ebPage Code:\en', '$2A')
        outlist_i('\ebPage Length:\en', Char(page+1), ' bytes')
        IF ((Char(page) AND %10000000) = 0) THEN outlist('\ebSave to NVRAM supported:\en', 'No') ELSE outlist('\ebSave to NVRAM supported:\en', 'Yes')
        IF ((Char(page+2) AND %00100000) = 0) THEN outlist('\ebDVD-RAM Read Support:\en', 'No') ELSE outlist('\ebDVD-RAM Read Support:\en', 'Yes')
        IF ((Char(page+2) AND %00010000) = 0) THEN outlist('\ebDVD-R Read Support:\en', 'No') ELSE outlist('\ebDVD-R Read Support:\en', 'Yes')
        IF ((Char(page+2) AND %00001000) = 0) THEN outlist('\ebDVD-ROM Read Support:\en', 'No') ELSE outlist('\ebDVD-ROM Read Support:\en', 'Yes')
        IF ((Char(page+2) AND %00000100) = 0) THEN outlist('\ebCD-R FPT Addressing 2 Read Support:\en', 'No') ELSE outlist('\ebCD-R FPT Addressing 2 Read Support:\en', 'Yes')
        IF ((Char(page+2) AND %00000010) = 0) THEN outlist('\ebCD-RW Read Support:\en', 'No') ELSE outlist('\ebCD-RW Read Support:\en', 'Yes')
        IF ((Char(page+2) AND %00000001) = 0) THEN outlist('\ebCD-R Read Support:\en', 'No') ELSE outlist('\ebCD-R Read Support:\en', 'Yes')

        IF ((Char(page+3) AND %00100000) = 0) THEN outlist('\ebDVD-RAM Write Support:\en', 'No') ELSE outlist('\ebDVD-RAM Write Support:\en', 'Yes')
        IF ((Char(page+3) AND %00010000) = 0) THEN outlist('\ebDVD-R Write Support:\en', 'No') ELSE outlist('\ebDVD-R Write Support:\en', 'Yes')
        IF ((Char(page+3) AND %00000100) = 0) THEN outlist('\ebTest Write Support:\en', 'No') ELSE outlist('\ebTest Write Support:\en', 'Yes')
        IF ((Char(page+3) AND %00000010) = 0) THEN outlist('\ebCD-RW Write Support:\en', 'No') ELSE outlist('\ebCD-RW Write Support:\en', 'Yes')
        IF ((Char(page+3) AND %00000001) = 0) THEN outlist('\ebCD-R Write Support:\en', 'No') ELSE outlist('\ebCD-R Write Support:\en', 'Yes')

        IF ((Char(page+4) AND %01000000) = 0) THEN outlist('\ebMultisession CD Support:\en', 'No') ELSE outlist('\ebMultisession CD Support:\en', 'Yes')
        IF ((Char(page+4) AND %00100000) = 0) THEN outlist('\ebMode 2 Form 2 Read Support:\en', 'No') ELSE outlist('\ebMode 2 Form 2 Read Support:\en', 'Yes')
        IF ((Char(page+4) AND %00010000) = 0) THEN outlist('\ebMode 2 Form 1 (XA) Read Support:\en', 'No') ELSE outlist('\ebMode 2 Form 1 (XA) Read Support:\en', 'Yes')
        IF ((Char(page+4) AND %00001000) = 0) THEN outlist('\ebDigital Output on Port 2:\en', 'No') ELSE outlist('\ebDigital Output on Port 2:\en', 'Yes')
        IF ((Char(page+4) AND %00000100) = 0) THEN outlist('\ebDigital Output on Port 1:\en', 'No') ELSE outlist('\ebDigital Output on Port 1:\en', 'Yes')
        IF ((Char(page+4) AND %00000010) = 0) THEN outlist('\ebComposite Audio Video Stream Support:\en', 'No') ELSE outlist('\ebComposite Audio Video Stream Support:\en', 'Yes')
        IF ((Char(page+4) AND %00000001) = 0) THEN outlist('\ebAudio Play Support:\en', 'No') ELSE outlist('\ebAudio Play Support:\en', 'Yes')

        IF ((Char(page+5) AND %10000000) = 0) THEN outlist('\ebRead Barcode Support:\en', 'No') ELSE outlist('\ebRead Barcode Support:\en', 'Yes')
        IF ((Char(page+5) AND %01000000) = 0) THEN outlist('\ebMedia Catalogue Number Support:\en', 'No') ELSE outlist('\ebMedia Catalogue Number Support:\en', 'Yes')
        IF ((Char(page+5) AND %00100000) = 0) THEN outlist('\ebInternational Standard Recording Code:\en', 'No') ELSE outlist('\ebInternational Standard Recording Code:\en', 'Yes')
        IF ((Char(page+5) AND %00010000) = 0) THEN outlist('\ebC2 Error Pointer Support:\en', 'No') ELSE outlist('\ebC2 Error Pointer Support:\en', 'Yes')
        IF ((Char(page+5) AND %00001000) = 0) THEN outlist('\ebRW Deinterleaved & Corrected:\en', 'No') ELSE outlist('\ebRW Deinterleaved & Corrected:\en', 'Yes')
        IF ((Char(page+5) AND %00000100) = 0) THEN outlist('\ebRW by Sub-Channel:\en', 'No') ELSE outlist('\ebRW by Sub-Channel:\en', 'Yes')
        IF ((Char(page+5) AND %00000010) = 0) THEN outlist('\ebRecover from CDDA loss of stream:\en', 'No') ELSE outlist('\ebRecover from CDDA loss of stream:\en', 'Yes')
        IF ((Char(page+5) AND %00000001) = 0) THEN outlist('\ebAudio Play via READ CD:\en', 'No') ELSE outlist('\ebAudio Play via READ CD:\en', 'Yes')

        IF ((Char(page+6) AND %11100000) = 0)
            outlist('\ebLoading Mechanism:\en', 'Caddy')
        ELSEIF ((Char(page+6) AND %11100000) = 32)
            outlist('\ebLoading Mechanism:\en', 'Tray')
        ELSEIF ((Char(page+6) AND %11100000) = 64)
            outlist('\ebLoading Mechanism:\en', 'Pop-Up')
        ELSEIF ((Char(page+6) AND %11100000) = 128)
            outlist('\ebLoading Mechanism:\en', 'Changer with individually changeable media')
        ELSEIF ((Char(page+6) AND %11100000) = 160)
            outlist('\ebLoading Mechanism:\en', 'Changer using a cartridge system')
        ELSE
            outlist('\ebLoading Mechanism:\en', 'Unknown')
        ENDIF

        IF ((Char(page+6) AND %00001000) = 0) THEN outlist('\ebEject via START/STOP w/ LoEj:\en', 'No') ELSE outlist('\ebEject via START/STOP w/ LoEj:\en', 'Yes')
        IF ((Char(page+6) AND %00000100) = 0) THEN outlist('\ebPrevent Jumper:\en', 'Off') ELSE outlist('\ebPrevent Jumper:\en', 'On')
        IF ((Char(page+6) AND %00000010) = 0) THEN outlist('\ebCurrent Lock State:\en', 'Unlocked - Media removal allowed') ELSE outlist('\ebCurrent Lock State:\en', 'Locked - Media removal prevented')
        IF ((Char(page+6) AND %00000001) = 0) THEN outlist('\ebMedia Locking Support:\en', 'No') ELSE outlist('\ebMedia Locking Support:\en', 'Yes')

        IF ((Char(page+7) AND %00100000) = 0) THEN outlist('\ebCD-Text Support:\en', 'No') ELSE outlist('\ebCD-Text Support:\en', 'Yes')
        IF ((Char(page+7) AND %00010000) = 0) THEN outlist('\ebSide Change Capable:\en', 'No') ELSE outlist('\ebSide Change Capable:\en', 'Yes')
        IF ((Char(page+7) AND %00000100) = 0) THEN outlist('\ebDisc Present Notification Support:\en', 'No') ELSE outlist('\ebDisc Present Notification Support:\en', 'Yes')
        IF ((Char(page+7) AND %00000010) = 0) THEN outlist('\ebAudio Channel Muting:\en', 'Global mute for all channels') ELSE outlist('\ebAudio Channel Muting:\en', 'Individual mute for each channel')
        IF ((Char(page+7) AND %00000001) = 0) THEN outlist('\ebAudio Channel Volumes:\en', 'Global volume control for all channels') ELSE outlist('\ebAudio Channel Volumes:\en', 'Individual volume control for each channel')

        outlist_i('\ebDescrete Volume Levels:\en ', Int(page+10), ' levels')
        outlist_i('\ebDatastream Buffer Size:\en ', Int(page+12), ' K')

        IF ((Char(page+17) AND %00110000) = 0)
            outlist('\ebDigital Output Length:\en:', '32 BCKs')
        ELSEIF ((Char(page+17) AND %00110000) = 16)
            outlist('\ebDigital Output Length:\en:', '16 BCKs')
        ELSEIF ((Char(page+17) AND %00110000) = 32)
            outlist('\ebDigital Output Length:\en:', '24 BCKs')
        ELSE
            outlist('\ebDigital Output Length:\en:', '24 BCKs (I2S)')
        ENDIF

        IF ((Char(page+17) AND %00001000) = 0) THEN outlist('\ebDigital Byte Order:\en', 'MSB (Big Endian)') ELSE outlist('\ebDigital Byte Order:\en', 'LSB (Little Endian)')
        IF ((Char(page+17) AND %00000100) = 0) THEN outlist('\ebRCK:\en', 'High on LRCK is right channel') ELSE outlist('\ebRCK:\en', 'High on LRCK is left channel')
        IF ((Char(page+17) AND %00000010) = 0) THEN outlist('\ebBCKF:\en', 'Valid on rising BCK') ELSE outlist('\ebBCKF:\en', 'Valid on falling BCK')

        outlist_i('\ebDVD Copy Protection Version:\en ', Int(page+22), NIL)
